...
// import static
// springfox.documentation.spi.service.contexts.Orderings.byPatternsCondition;
...
// removeSpringfoxHandlerProvider(DocumentationPluginsBootstrapper bootstrapper)
// {
// return () ->
// bootstrapper.getHandlerProviders().removeIf(WebMvcRequestHandlerProvider.class::isInstance);
// }

// @Bean
// public RequestHandlerProvider
// customRequestHandlerProvider(Optional<ServletContext> servletContext,
// HandlerMethodResolver methodResolver, List<RequestMappingInfoHandlerMapping>
// handlerMappings) {
// String contextPath =
// servletContext.map(ServletContext::getContextPath).orElse(ROOT);
...
// return info;
// String[] patterns =
// info.getPatternsCondition().getPatternValues().toArray(String[]::new);
// return info.mutate().options(new
// RequestMappingInfo.BuilderConfiguration()).paths(patterns).build();
// }
// }